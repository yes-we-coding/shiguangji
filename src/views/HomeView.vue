...
<template>
  <div class="container layout">
    <aside class="side-col side-left">
      ...
      <YearProgress class="fade-in" style="--delay: 0.15s" />
      <HabitCheckin class="fade-in" style="--delay: 0.2s" />
      <DailyQuote class="fade-in" style="--delay: 0.25s" />
      <SiteStats class="fade-in" style="--delay: 0.3s" />
    </aside>
    <main class="main-col">
    ...
    <aside class="side-col side-right">
      ...
      <TagCloud class="fade-in" style="--delay: 0.35s" />
    </aside>
  </div>
</template>
